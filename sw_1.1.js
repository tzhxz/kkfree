...
// const cacheStorageKey = "ky-bs-v1"
// const apiCacheName = "ky-api-v1";
//
// const cacheList = [
//     '/'
// ]
...
self.addEventListener('fetch', (event) => {
    ...
    if (tempArr[2].indexOf('kyfungo.com') == -1||event.request.url.indexOf('sw_1.1.js')!=-1||event.request.url.indexOf('index.html')!=-1) {
        return fetch(event.request);
    }
    event.respondWith(
    ...
    e.waitUntil(
        ...
        self.clients.matchAll().then(function (clients) {
            if (!clients || clients.length === 0) {
                self.clients.openWindow && self.clients.openWindow('https://kyfungo.com');
                return;
            }
