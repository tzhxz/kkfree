...
t = this, e = function () {
    ...
    _t.prototype.listen = function (t) {
        ...
        if (v(t, o) && u === c && t.matched[u] === o.matched[c]) return this.ensureURL(), s(((a = wt(i = o, t, yt.duplicated, 'Avoided redundant navigation to current location: "' + i.fullPath + '".')).name = "NavigationDuplicated", a));
        var p = function (t, e) {
    ...
    }, Vt.version = "3.5.2", Vt.isNavigationFailure = Rt, Vt.NavigationFailureType = yt, Vt.START_LOCATION = h, D && window.Vue && window.Vue.use(Vt), Vt
