 ...
 */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Vuex = e()
}(this, (function () {
    "use strict";
    ...
    function e(t, n) {
        ...
        return n.push({original: t, copy: i}), Object.keys(t).forEach((function (o) {
            i[o] = e(t[o], n)
        })), i
    }
    ...
    a.prototype.get = function (t) {
        ...
        var e = this.get(t.slice(0, -1)), n = t[t.length - 1], o = e.getChild(n);
    ...
    var s = function (e) {
        ...
        var i = this, s = this.dispatch, u = this.commit;
    ...
    function p(t, e, n, o, r) {
        ...
        if (o.namespaced && (t._modulesNamespaceMap[a], t._modulesNamespaceMap[a] = o), !i && !r) {
            var s = d(e, n.slice(0, -1)), u = n[n.length - 1];
        ...
        var f = o.context = function (t, e, n) {
            var o = "" === e, r = {
                dispatch: o ? t.dispatch : function (n, o, r) {
                    var i = m(n, o, r), c = i.payload, a = i.options, s = i.type;
    ...
    u.state.get = function () {
        ...
        var o = this, r = m(t, e, n), i = r.type, c = r.payload, a = {type: i, payload: c}, s = this._mutations[i];
        ...
        var n = this, o = m(t, e), r = o.type, i = o.payload, c = {type: r, payload: i}, a = this._actions[r];
        if (a) {
            try {
        ...
        createLogger: function (t) {
            ...
            return void 0 === f && (f = console), function (t) {
                ...
                void 0 !== f && (s && t.subscribe((function (t, c) {
                    var a = e(c);
                    if (o(t, l, a)) {
                        var s = O(), u = i(t), h = "mutation " + t.type + s;
                    ...
                    if (c(t, e)) {
                        var o = O(), r = a(t), i = "action " + t.type + o;
